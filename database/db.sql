...
ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS termos_aceitos TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE pets ADD COLUMN IF NOT EXISTS tipo VARCHAR(50) NOT NULL DEFAULT 'Cachorro' AFTER nome;
ALTER TABLE pets MODIFY tipo VARCHAR(50) NOT NULL DEFAULT 'Cachorro';
ALTER TABLE pets ADD COLUMN IF NOT EXISTS criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
